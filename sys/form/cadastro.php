<div class="interface">
    ...
    <form name="form1" method="POST" action="" onsubmit="confirm()">
        ...
        <label>Nome do neg�cio: </label> <span class='obs'>(opcional)</span> <input type="text" name="business" id="business"> <br/><br/>
        <label>Endereço: </label><input type="text" name="end" id="end" required> <label>Complemento: </label><span class='obs'>(opcional)</span> <input type="text" name="complement" id="complement"><br/><br/>
